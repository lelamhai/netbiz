...
<main class="main">
      ...
      <div class="w300 rt">
         <div class="cat-listing cat-top-stories no-meta no-desc title-1622">
            <div class="cat-title mb35">
               <h2 class="cat-name cat-name-top-stories"><span>Top Stories</span></h2>
            </div>
                     ...
                     <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                        <article class="article">
                           ...
                           <div class="article-info">
                              ...
                              <div class="article-desc mobile"><?php the_excerpt()?></div>
                           </div>
                        </article>
                     <?php endwhile; ?>
                     <?php wp_reset_postdata(); ?>
   ...
   <div class="cat-emagazine bg-grey-f8 no-meta mb30 clearfix">
      <div class="wrapper cat-emagazine-inner">
         ...
         <div class="cat-content" id="emagazine">
            <!-- 10 -->
                     <?php 
                     $args = array(
                        'post_type' => 'post',
